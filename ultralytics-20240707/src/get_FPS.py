...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'C:\Users\Sen\Desktop\ultralytics-20240707\runs\train\yolov8\weights\best.pt', help='trained weights path')
    ...
    parser.add_argument('--warmup', default=100, type=int, help='warmup time')
    parser.add_argument('--testtime', default=200    , type=int, help='test time')
...
#shell:
#nohup python /hy-tmp/ultralytics-20240707/src/get_FPS.py --weights /hy-tmp/runs/prune/exp3-0.005/slc-yolov8n-groupsl-0.005-finetune/weights/best.pt --batch 32 --device cpu --warmup 100 --testtime200 > /hy-tmp/Result/FPS_result_log/env_CPU/slc-0.005-sp2.0-fps.log 2>&1 & tail -f /hy-tmp/Result/FPS_result_log/env_CPU/slc-0.005-sp2.0-fps.log